...
\begin{frame}{General Info I}
	\begin{itemize}
		...
		\item Stream observer shifts %%do we have stream observers?-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
		\item Difficult talks together with additional video director %Do we have them?------------------------------------------------------------------------------------------------------------------------------------------------
	\end{itemize}
\end{frame}
...
\begin{frame}{General Info II}
	\begin{itemize}
		...
		\item Slides available online: \texttt{https://streaming.selfnet.de/engelschulung.pdf}%to-be-updated--------------------------------------------------------------------------------------------------------------------------------------------------------
	\end{itemize}
	\begin{figure} 
		\centering
...
\begin{frame}{Angeltypes}
	\begin{itemize}
		...
		\item Stream Observing Angels%%do we have stream observers?-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
		\item A/V Technician
		\item Stage Manager
	\end{itemize}
\end{frame}
...
\begin{frame}{Camera Angels}
	\begin{itemize}
		...
		\item Usually, two video angels per lecture hall %%still two??-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
\begin{frame}{Video Mixer Angels}
	\begin{itemize}
		...
		\item Challenging talks, with assistance from an external "image composition director" joining the intercom channel.%%do we have these ?---------------------------------------------------------------------------------------------------------------------------------------------------------
	\end{itemize}
\end{frame}

\begin{frame}{Stream Observing Angels}%%do we have stream observers?-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	\begin{itemize}
...
\begin{frame}{A/V Technician}
	\begin{itemize}
		...
		\item is on intercom
		\item A/V techs meet after this meeting %%do we need aditional techs?-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	\end{itemize}
\end{frame}
...
\begin{frame}{Saal Metiner}
	\begin{figure} 
		\centering
		\includegraphics[height=0.9\textheight]{images/SaalB.png}%TODO: Photos / mag----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	\end{figure}
\end{frame}
...
\section{Intercom} %Photos of the intercom used a camp-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
\item Get coached in
	...
	\end{itemize}
\item Starting tomorrowafter the review meeting
\end{itemize} 
\end{frame}
...
\begin{itemize}
	...
	\item Angels - Frederik DECT \textbf{7658}
	\item Organizational or social problems - jwacalex - DECT \textbf{5542}
...
Contact us on congress via irc, voc-lounge on hackint or come to the VOC office.4
\end{frame}
