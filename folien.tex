...
\begin{frame}{Zoom Control Panasonic}
	...
	\begin{figure} 
		\centering
		\includegraphics[width=0.9\textwidth]{images/panasonic_zoom.png}
		\caption{Panasonic Cam}
	\end{figure}
		\column{0.5\textwidth}
		For smooth zoom use the zoom buttons.

		Press the variable speed Zoom Button gently for slow zoom and further for fast zoom.

		The Zoom Button on top have a fixed speed.
	\end{columns}
\end{frame}
