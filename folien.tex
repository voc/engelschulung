...
\begin{frame}{General Info I}
	\begin{itemize}
		...
		\item Difficult talks together with additional video director%%TODO Do we have these?
	\end{itemize}
\end{frame}
...
\begin{frame}{Camera Angels}
	...
	\end{itemize}
	%%TODO Photo of camera angel for illustration purposes
\end{frame}
...
\begin{frame}{Video Mixer Angels}
	...
	\end{itemize}
	%%TODO Photo of mixer angel for illustration purposes
\end{frame}
...
\begin{frame}{Stream Observing Angels}
	...
	\end{itemize}
	%%TODO Photo of stream observer angel for illustration purposes
\end{frame}
...
\begin{frame}{Software Video Mixer - Voctomix2}%%Voctomix2
	\begin{figure} 
		\centering
		\includegraphics[width=.9\textwidth]{images/voctomix.png}%%Add Voctomix2 image
		\caption{Voctomix2}
	\end{figure}
\end{frame}

\begin{frame}{Voctomix2}%%finish slide
\begin{itemize}
