...
\begin{frame}{General Info II}
	\begin{itemize}
		...
		\item Slides available online: \texttt{https://streaming.selfnet.de/engelschulung.pdf}%TODO to-be-updated--------------------------------------------------------------------------------------------------------------------------------------------------------
	\end{itemize}
	\begin{figure} 
		\centering
...
%		\item Observer shifts are in the VOC office. 
%	\end{itemize}
%\end{frame}
...
\begin{frame}{A/V Technician}
	\begin{itemize}
		...
		%\item A/V techs meet today at 7:30 pm.
	\end{itemize}
\end{frame}
...
%	\begin{figure} 
%		\centering
%		\includegraphics[height=0.9\textheight]{images/CCC_Camp_2019_map.png}
%	\end{figure}
%\end{frame}
...
%\begin{frame}{Saal Meitner}
%	\begin{figure} 
%		\centering
%		\includegraphics[height=0.9\textheight]{images/ccc_camp_2019_meitner.png}
%	\end{figure}
%\end{frame}
...
%	\begin{figure} 
%		\centering
%		\includegraphics[height=0.9\textheight]{images/camp_2019_intercom.png}
%	\end{figure}
%\end{frame}
...
%\begin{frame}{Software Video Mixer - Voctogui 2}
%		\begin{alertblock}{Do NOT touch!}
%			\begin{itemize}
%				\item Needs no attention. 
%				\item Might show up some time, might blink.
%				\item Just ignore, it's alpa software.
%			\end{itemize}
%		\end{alertblock}
%\end{frame}
...
%		\item Mixer Angel requests pictures from Camera Angels and announces his/her next steps
...
%\begin{frame}{Quality}
%\begin{itemize}
%\item Hands-on training with Capo after the review sessions
%\item Hands-on training on the non-productive Voctomix 2 machines during the talks.
...
%\end{itemize}
%\item Solution: Short Hands-On-Training after the review sessions if there is time
...
%	\end{itemize}
%\item Starting tomorrow after the review meeting
%\end{itemize} 
%\end{frame}
%
%
...
%\begin{itemize}
%	\item We meet in Lecture Room Meitner everyday at 3 pm \\
...
%	\item  \textbf{Optional} for other A/V Angels
...
%	\item Remarkable Examples, Short Feedback Round (15 mins)
%	\item Shift Distribution (20 mins)
...
%	\item Your shift starts 15min. prior to the talk. Use that time to get used to the setup and talk to your fellow video angles!
%\end{itemize} 
%\end{frame}
%			
%\begin{frame}{Voctomix 2 in "Three headed monkey village"}
%	\begin{itemize}
%		\item In the THM Village (Three Headed Monkey Village) there is a running voctomix 2 setup\\
%		\item You'll find camera and mixer shifts for the talks in that village in the engelsystem.
%		\item For all the technical stuff, how to use the voctomix 2 etc. ask the people in the village, \textbf{VOC is not responsible for that setup!}
%		\item You should consider arriving a bit earlier to your shift to get used to the voctomix 2 setup.
%	\end{itemize} 
%\end{frame}
